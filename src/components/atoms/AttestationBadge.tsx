...
export const AttestationBadge: React.FC<AttestationBadgeProps> = ({
  ...
  return (
    <div
      className="rounded-lg flex border border-whiteOpacity008 w-[21vw] h-[25vh] bg-whiteOpacity005"
      {...props}
    >
      ...
      <div className="flex flex-1 max-w-[50%] flex-col align-center">
        <div className="flex-1 m-4 ml-6 h-[25px]">
          <div
            className={cc([{ hidden: !imported }, "flex text-xs font-medium justify-end"])}
          >
